...
#     for (name, train_test_sets, y_test_pred), marker in zip(models, markers):
#         _, _, _, y_test = train_test_sets

#         y_test = np.asarray(y_test)
#         y_test_pred = np.asarray(y_test_pred)
#         r2train = r2_score(train_test_sets[1], train_test_sets[3])
#         r2 = r2_score(y_test, y_test_pred)
#         rmse_score = root_mean_squared_error(y_test, y_test_pred)

#         label = (
#             rf"{name}: "
#             rf"$R^2_{{\rm train}}$={r2train:.3f}, "
#             rf"$R^2_{{\rm test}}$={r2:.3f}, "
#             rf"RMSE={rmse_score:.3f}"
#         )
...
#     plt.tight_layout()
#     plt.savefig("Figures/Residuals_radius.pdf")
#     plt.show()
